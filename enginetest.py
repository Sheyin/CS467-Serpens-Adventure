      ...
      if userRoom != currentState.currRoom:  #Displays room description when player moves rooms
         ...
         if currentState.currRoom == 1:   #Brig
            ...
            if currentState.rm13vis == 0: 
               print control.longDesc
               currentState.rm13vis = 1 #Update to visited
            else:
               print control.shortDesc
      ...
      if userInput == "1":#Look at feature 1 - STRAW / ENTRYWAY MARKINGS / LOCKER / EXAM ENTRYWAY / DOOR / BOTTLE / GUN CABINET / BUNKS / CANVAS FLAP / LADDER / LADDER / PLANTS
         ...
         #Control
            ...
            if currentState.rm13f1 == 0: #Before interaction
               print control.feat1desc 
            else: #After interaction
               print control.feat1interactComplete
         #Side
         elif currentState.currRoom == 14:
            if currentState.rm14f1 == 0: #Before interaction
               print side.feat1desc 
            else: #After interaction
               print side.feat1interactComplete
         #Processing
         elif currentState.currRoom == 15:
            if currentState.rm15f1 == 0: #Before interaction
               print processing.feat1desc 
            else: #After interaction
               print processing.feat1interactComplete
         ...
         #Control
            ...
            if currentState.rm13f2 == 0: #Before interaction
                print control.feat2desc 
            else: #After interaction
                print control.feat2interactComplete
         #Side
         elif currentState.currRoom == 14:
            if currentState.rm14f2 == 0: #Before interaction
                print side.feat2desc 
            else: #After interaction
                print side.feat2interactComplete
         #Processing
         elif currentState.currRoom == 15:
            if currentState.rm15f2 == 0: #Before interaction
                print processing.feat2desc 
            else: #After interaction
                print processing.feat2interactComplete
         ...
         #Control
            ...
            if currentState.rm13f3 == 0: #Before interaction
               print control.feat3desc 
            else: #After interaction
               print control.feat3interactComplete
         #Side
         elif currentState.currRoom == 14:
            if currentState.rm14f3 == 0: #Before interaction
               print side.feat3desc 
            else: #After interaction
               print side.feat3interactComplete
         #Processing
         elif currentState.currRoom == 15:
            if currentState.rm15f3 == 0: #Before interaction
               print processing.feat3desc 
            else: #After interaction
               print processing.feat3interactComplete
         ...
         #Control
            ...
            if currentState.rm13f4 == 0: #Before interaction
               print control.feat4desc 
            else: #After interaction
               print control.feat4interactComplete
         #Side
         elif currentState.currRoom == 14:
            if currentState.rm14f4 == 0: #Before interaction
               print side.feat4desc 
            else: #After interaction
               print side.feat4interactComplete
         #Processing
         elif currentState.currRoom == 15:
            if currentState.rm15f4 == 0: #Before interaction
               print processing.feat4desc 
            else: #After interaction
               print processing.feat4interactComplete
         ...
         #Control
            ...
            if currentState.rm13f5 == 0: #Before interaction
               print control.feat5desc 
            else: #After interaction
               print control.feat5interactComplete
         #Side
         elif currentState.currRoom == 14:
            if currentState.rm14f5 == 0: #Before interaction
               print side.feat5desc 
            else: #After interaction
               print side.feat5interactComplete
         #Processing
         elif currentState.currRoom == 15:
            if currentState.rm15f5 == 0: #Before interaction
               print processing.feat5desc 
            else: #After interaction
               print processing.feat5interactComplete
         ...
         #Garden
            ...
            if currentState.rm12f6 == 0: #Before interaction
               ...
               print garden.feat6interactComplete
         #Control
         elif currentState.currRoom == 13:
            if currentState.rm13f6 == 0: #Before interaction
               print control.feat6desc 
            else: #After interaction
               print control.feat6interactComplete
         #Side
         elif currentState.currRoom == 14:
            if currentState.rm14f6 == 0: #Before interaction
               print side.feat6desc 
            else: #After interaction
               print side.feat6interactComplete
         ...
         #Control
            ...
            print control.feat6interactSuccess
            currentState.rm13f6 = 1 #Update to interaction complete
         #Side
         elif currentState.currRoom == 14:
            print side.feat6interactSuccess
